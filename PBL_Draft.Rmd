...
ridership_map <- tm_shape(com_areas) +
  ...
  tmap_save(ridership_map, "ridership_map.png", width = 9, height = 8, units = "in", dpi = 300)
```
...
ridership_v_crimecount <- plot(cta_rail_stations_sf$crime_count_05,
     cta_rail_stations_sf$total_rides_2025 / 1e6,
     pch = 19,
     col = "darkgray",
     xlab = "Crime Count within 0.5 Miles",
     ylab = "Ridership in Millions (2025)",
     main = "CTA 2025 Ridership vs Crime Count",
     yaxt = "n")
axis(2, at = 0:3, labels = 0:3)
model <- lm(total_rides_2025/1e6 ~ crime_count_05, data = cta_rail_stations_sf)
...
```{r}
png("mindist_v_crimecount.png", width = 2000, height = 1500, res = 300)
